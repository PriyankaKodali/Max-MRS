...
class EditDoctor extends Component {
    ...
    constructor(props) {
        ...
        var i = 0;
        this.state = {
            Doctor: [], Clients: [], Client: null, Countries: [], Country: null, States: [], State: null,
            Cities: [], City: null, DictationMode: null, JobLevel: null, Doctor_Id: null, Specialities: [],
            Speciality: null, DoctorGroups: [], DoctorGroup: null

        }
    }

    componentWillMount() {
        this.setState({ Doctor_Id: this.props.match.params["id"] });
        ...
        $.ajax({
            ...
            type: "get",
            success: (data) => {
                this.setState({ Specialities: data["specialties"] })
            }
        })
                                ...
                                <div className="col-md-6">
                                    ...
                                    <div className="form-group">
                                        <div className="input-group">
                                            ...
                                            <input className="col-md-5 form-control" name="AddressLine1" type="text" ref="addressLine1" placeholder="Address Line 1 " autoComplete="off" value={this.state.Doctor["Addressline1"]} />
                                        </div>
                                    </div>
                                </div>
                                <div className="col-md-6">
                                    ...
                                    <div className="form-group">
                                        <div className="input-group">
                                            ...
                                            <input className="col-md-5 form-control" type="text" name="AddressLine2" ref="addressLine2" placeholder="Address Line 2" autoComplete="off" value={this.state.Doctor["AddressLine2"]} />
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    handleSubmit(e) {
        ...
        let url = ApiUrl + "api/Doctors/UpdateDoctor?doctor_Id=" + this.props.match.params["id"]
